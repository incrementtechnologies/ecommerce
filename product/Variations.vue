            ...
            <tbody>
              <tr v-for="(itemVariation, indexVariation) in variationData.variation" :key="indexVariation">
                ...
                <td>
                  ...
                  <button v-if="isEdit === true && ((itemVariation.product_trace_qty === 0 || itemVariation.product_trace_qty === null) && (itemVariation.total_transferred_variation === 0 || itemVariation.total_transferred_variation === null))" class="btn btn-danger btn-sm" style="margin-left: 10px;" @click="addOrDelete(itemVariation, false)" title="Delete Inventory" :disabled="isEdit===false">Delete</button>
                </td>
              </tr>
            </tbody>
          </table>

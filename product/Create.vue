<template>
  <div>
    <button class="btn btn-primary pull-right" data-toggle="modal" data-target="#createProductModal" @click="errorMessage = null" style="margin-bottom: 25px;" v-if="user.subAccount !== null && user.subAccount.merchant !== null && user.subAccount.merchant.status === 'verified'"><i class="fa fa-plus"></i> New Product
    </button>
